...
> Current release: **1.0.0** · Windows 10/11 x64
...
1. Download `Arist-AI-Control-v1.0.0-Windows-x64.zip` from [GitHub Releases](https://github.com/Ketavin/Aristcontrol/releases).
